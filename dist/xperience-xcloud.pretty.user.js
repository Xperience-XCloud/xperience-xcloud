...
// @grant        none
// @updateURL    https://raw.githubusercontent.com/Xperience-XCloud/xperience-xcloud/typescript/dist/xperience-xcloud.meta.js
// @downloadURL  https://github.com/Xperience-XCloud/xperience-xcloud/releases/latest/download/xperience-xcloud.user.js
// ==/UserScript==
"use strict";
class BxLogger {
...
class UserAgent {
 static STORAGE_KEY = "XperienceXCloud.UserAgent";
 static #config;
...
class GhPagesUtils {
 static fetchLatestCommit() {
  NATIVE_FETCH("https://api.github.com/repos/xperience-xcloud/Xperience-XCloud/branches/gh-pages", {
   method: "GET",
   headers: {
   ...
   window.localStorage.setItem("XperienceXCloud.GhPages.CommitHash", latestCommitHash);
  }).catch((error) => {
 ...
 static getUrl(path) {
  ...
  let prefix = "https://raw.githubusercontent.com/xperience-xcloud/Xperience-XCloud", latestCommitHash = window.localStorage.getItem("XperienceXCloud.GhPages.CommitHash");
 ...
 static getNativeMkbCustomList(update = !1) {
  let key = "XperienceXCloud.GhPages.ForceNativeMkb";
 ...
 static getTouchControlCustomList() {
  let key = "XperienceXCloud.GhPages.CustomTouchLayouts";
 ...
 static getLocalCoOpList() {
  let key = "XperienceXCloud.GhPages.LocalCoOp";
...
class Translations {
 static EN_US = "en-US";
 static KEY_LOCALE = "XperienceXCloud.Locale";
 static KEY_TRANSLATIONS = "XperienceXCloud.Locale.Translations";
...
class LocalDb {
 ...
 static DB_NAME = "XperienceXCloud";
 static DB_VERSION = 4;
...
class GlobalSettingsStorage extends BaseSettingsStorage {
 static DEFINITIONS = {
  ...
  "bx.locale": {
   label: t("language"),
   default: localStorage.getItem("XperienceXCloud.Locale") || "en-US",
  ...
  "mkb.enabled": {
   ...
   ready: (setting) => {
    let note, url;
    if (setting.unsupported) note = t("browser-unsupported-feature"), url = "https://github.com/Xperience-XCloud/xperience-xcloud/issues/206#issuecomment-1920475657";
    else note = t("mkb-disclaimer"), url = "https://xperience-xcloud.github.io/mouse-and-keyboard/#disclaimer";
 ...
 constructor() {
  super("XperienceXCloud", GlobalSettingsStorage.DEFINITIONS);
 }
}
...
class GameSettingsStorage extends BaseSettingsStorage {
 constructor(id) {
  super(`${"XperienceXCloud.Stream"}.${id}`, StreamSettingsStorage.DEFINITIONS);
 }
 isEmpty() {
...
class StreamSettingsStorage extends BaseSettingsStorage {
 static DEFINITIONS = {
  ...
  "localCoOp.enabled": {
   ...
   default: !1,
   note: () => CE("div", !1, CE("a", {
    href: "https://github.com/xperience-xcloud/xperience-xcloud/discussions/275",
    target: "_blank"
 ...
 xboxTitleId = -1;
 constructor() {
  super("XperienceXCloud.Stream", StreamSettingsStorage.DEFINITIONS);
 }
 setGameId(id) {
  this.xboxTitleId = id;
 }
...
function migrateStreamSettings() {
 let storage = window.localStorage, globalSettings = JSON.parse(storage.getItem("XperienceXCloud") || "{}"), streamSettings = JSON.parse(storage.getItem("XperienceXCloud.Stream") || "{}"), modified2 = !1;
 ...
 if (modified2) storage.setItem("XperienceXCloud", JSON.stringify(globalSettings)), storage.setItem("XperienceXCloud.Stream", JSON.stringify(streamSettings));
}
...
function checkForUpdate() {
 ...
 fetch("https://api.github.com/repos/Xperience-XCloud/xperience-xcloud/releases/latest").then((response) => response.json()).then((json) => {
...
function clearAllData() {
 for (let i = 0;i < localStorage.length; i++) {
  ...
  if (!key) continue;
  if (key.startsWith("XperienceXCloud") || key.startsWith("xperience_xcloud")) localStorage.removeItem(key);
 }
 try {
...
var PointerToMouseButton = {
 ...
 2: 2,
 4: 1
}, VIRTUAL_GAMEPAD_ID = "Xperience XCloud Virtual Controller";
 ...
 static setup() {
  ...
  BxEventBus.Stream.on("dataChannelCreated", (payload) => {
   ...
   dataChannel.addEventListener("message", (msg) => {
    if (msg.origin === "xperience-xcloud" || typeof msg.data !== "string") return;
...
class PatcherCache {
 ...
 KEY_CACHE = "XperienceXCloud.Patches.Cache";
 KEY_SIGNATURE = "XperienceXCloud.Patches.Cache.Signature";
 CACHE;
 constructor() {
...
class SuggestionsSetting {
 static async renderSuggestions(e) {
  ...
  $content = CE("div", {
   ...
   href: "https://xperience-xcloud.github.io/guide/android-webview-tweaks/",
   target: "_blank",
   tabindex: 0
  }, "🤓 " + t("how-to-improve-app-performance")), BX_FLAGS.DeviceInfo.deviceType.includes("android") && !hasRecommendedSettings && CE("a", {
   class: "bx-suggest-link bx-focusable",
   href: "https://github.com/Xperience-XCloud/xperience-xcloud-devices",
   target: "_blank",
   tabindex: 0
...
class SettingsDialog extends NavigationDialog {
 ...
 TAB_GLOBAL_ITEMS = [{
  group: "general",
  label: t("xperience-xcloud"),
  helpUrl: "https://xperience-xcloud.github.io/features/",
  items: [
   ($parent) => {
    ...
    if (!SCRIPT_VERSION.includes("beta") && PREF_LATEST_VERSION && PREF_LATEST_VERSION != SCRIPT_VERSION) {
     ...
     else opts.url = "https://github.com/Xperience-XCloud/xperience-xcloud/releases/latest";
    ...
    if (AppInterface) topButtons.push(createButton({
      ...
      style: 128 | 64,
      url: "https://xperience-xcloud.github.io/android"
     }));
  ...
  items: [
   "nativeMkb.mode",
   {
    ...
    multiLines: !0,
    note: CE("a", { href: "https://github.com/Xperience-XCloud/xperience-xcloud/discussions/574", target: "_blank" }, t("unofficial-game-list"))
   },
   "mkb.enabled",
   "mkb.cursor.hideIdle"
  ],
  ...!STATES.browser.capabilities.emulatedNativeMkb && (!STATES.userAgent.capabilities.mkb || !STATES.browser.capabilities.mkb) ? {
   ...
   unsupportedNote: CE("a", {
    href: "https://github.com/Xperience-XCloud/xperience-xcloud/issues/206#issuecomment-1920475657",
    target: "_blank"
  ...
  items: [
   {
    ...
    note: CE("a", { href: "https://github.com/Xperience-XCloud/xperience-xcloud/discussions/241", target: "_blank" }, t("unofficial-game-list"))
   },
   "touchController.autoOff",
   "touchController.opacity.default",
   "touchController.style.standard",
  ...
  items: [
   ...
   ($parent) => {
    $parent.appendChild(CE("a", {
     ...
     href: "https://ko-fi.com/xperiencexcloud",
     target: "_blank",
     tabindex: 0
    }, `❤️ ${t("support-xperience-xcloud")}`));
   },
   ($parent) => {
    ...
    $parent.appendChild(CE("div", { class: "bx-debug-info" }, createButton({
     ...
     onClick: (e) => {
      ...
      if (!$pre) {
       ...
       debugInfo.settings = JSON.parse(window.localStorage.getItem("XperienceXCloud") || "{}"), $pre = CE("pre", {
 ...
 TAB_DISPLAY_ITEMS = [{
  ...
  group: "audio",
  label: t("audio"),
  helpUrl: "https://xperience-xcloud.github.io/ingame-features/#audio",
  items: [{
   pref: "audio.volume",
   params: {
  ...
  group: "video",
  label: t("video"),
  helpUrl: "https://xperience-xcloud.github.io/ingame-features/#video",
  items: [
   "video.player.type",
   "video.maxFps",
   "video.player.powerPreference",
 ...
 TAB_CONTROLLER_ITEMS = [
  {
   group: "controller",
   label: t("controller"),
   helpUrl: "https://xperience-xcloud.github.io/ingame-features/#controller",
   items: [
    "localCoOp.enabled",
    "controller.pollingRate",
    ($parent) => {
 ...
 TAB_MKB_ITEMS = [
  {
   ...
   group: "mkb",
   label: t("mouse-and-keyboard"),
   helpUrl: "https://xperience-xcloud.github.io/mouse-and-keyboard/",
   items: [
    ($parent) => {
 ...
 TAB_STATS_ITEMS = [{
  ...
  helpUrl: "https://xperience-xcloud.github.io/stream-stats/",
  items: [
   "stats.showWhenPlaying",
   "stats.quickGlance.enabled",
   "stats.items",
 ...
 renderSettingsSection(settingTab, sections) {
  ...
  for (let section of sections) {
   ...
   if (label === t("xperience-xcloud")) {
    if (label += " " + SCRIPT_VERSION, SCRIPT_VARIANT === "lite") label += " (Lite)";
    label = createButton({
     label,
     url: "https://github.com/Xperience-XCloud/xperience-xcloud/releases",
     style: 4096 | 16 | 64
    });
   }
   if (label) {
 ...
 resetHighlightedSetting($elm) {
  ...
  if (deleted) BxEventBus.Stream.emit("setting.changed", {
    storageKey: `${"XperienceXCoud.Stream"}.${targetGameId}`,
    settingKey: pref
   });
  return deleted;
 }
...
class HeaderSection {
 ...
 constructor() {
  ...
  this.$buttonsWrapper = CE("div", !1, !getGlobalPref("block.features").includes("remote-play") ? this.$btnRemotePlay : null, this.$btnSettings), BxEventBus.Script.on("xcloud.server", ({ status }) => {
   if (status === "ready") {
    STATES.isSignedIn = !0, $btnSettings.querySelector("span").textContent = getPreferredServerRegion(!0) || t("xperience-xcloud");
...
class RemotePlayDialog extends NavigationDialog {
 ...
 setupDialog() {
  ...
  $fragment.appendChild(CE("div", {
   ...
   icon: BxIcon.QUESTION,
   style: 8 | 64,
   url: "https://xperience-xcloud.github.io/remote-play",
   label: t("help")
  }), createButton({
   style: 8 | 64,
   label: t("close"),
...
function onHistoryChanged(e) {
 if (e && e.arguments && e.arguments[0] && e.arguments[0].origin === "xperience-xcloud") return;
...
class StreamUiHandler {
 ...
 static handleSystemMenu($streamHud) {
  ...
  if (typeof $btnStreamSettings === "undefined") $btnStreamSettings = StreamUiHandler.cloneStreamHudButton($orgButton, t("xperience-xcloud"), BxIcon.XPERIENCE_XCLOUD), $btnStreamSettings?.addEventListener("click", (e) => {
...
if (window.location.pathname.includes("/auth/msa")) {
 ...
 }, new Error("[Xperience XCloud] Refreshing the page after logging in");
}
...
if (BX_FLAGS.SafariWorkaround && document.readyState !== "loading") {
 ...
 if (isSafari) $secondaryAction = CE("p", !1, t("settings-reloading"));
   ...
   href: "https://xperience-xcloud.github.io/troubleshooting",
   target: "_blank"
  }, "🤓 " + t("how-to-fix"));
 let $fragment = document.createDocumentFragment();
 throw $fragment.appendChild(CE("style", !1, css)), $fragment.appendChild(CE("div", {
  class: "bx-reload-overlay"
 }, CE("div", !1, CE("p", !1, t("load-failed-message")), $secondaryAction))), document.documentElement.appendChild($fragment), isSafari && window.location.reload(!0), new Error("[Xperience XCloud] Executing workaround for Safari");
}
if (!window.location.pathname.match(/^\/[a-zA-Z]{2}-[a-zA-Z]{2}\/play/)) throw new Error("[Xperience XCloud] Not xCloud page");
