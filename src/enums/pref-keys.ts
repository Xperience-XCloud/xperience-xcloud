...
export const enum StorageKey {
    GLOBAL = 'XperienceXCloud',
    STREAM = 'XperienceXCloud.Stream',

    LOCALE = 'XperienceXCloud.Locale',
    LOCALE_TRANSLATIONS = 'XperienceXCloud.Locale.Translations',
    PATCHES_CACHE = 'XperienceXCloud.Patches.Cache',
    PATCHES_SIGNATURE = 'XperienceXCloud.Patches.Cache.Signature',
    USER_AGENT = 'XperienceXCloud.UserAgent',

    GH_PAGES_COMMIT_HASH = 'XperienceXCloud.GhPages.CommitHash',
    LIST_CUSTOM_TOUCH_LAYOUTS = 'XperienceXCloud.GhPages.CustomTouchLayouts',
    LIST_FORCE_NATIVE_MKB = 'XperienceXCloud.GhPages.ForceNativeMkb',
    LIST_LOCAL_CO_OP = 'XperienceXCloud.GhPages.LocalCoOp',
}
