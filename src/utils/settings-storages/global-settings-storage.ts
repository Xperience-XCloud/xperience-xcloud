        ...
        [GlobalPref.MKB_ENABLED]: {
            ...
            ready: (setting: SettingDefinition) => {
                ...
                if (setting.unsupported) {
                    ...
                    url = 'https://github.com/xperience-xcloud/xperience-xcloud/issues/206#issuecomment-1920475657';
                } else {
                    note = t('mkb-disclaimer');
                    url = 'https://xperience-xcloud.github.io/mouse-and-keyboard/#disclaimer';
                }
