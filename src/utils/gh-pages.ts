...
export class GhPagesUtils {
    static fetchLatestCommit() {
        const url = 'https://api.github.com/repos/xperience-xcloud/xperience-xcloud/branches/gh-pages';
    ...
    static getUrl(path: string): string {
        ...
        const prefix = 'https://raw.githubusercontent.com/xperience-xcloud/xperience-xcloud';
